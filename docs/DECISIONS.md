...
- **لا "ادّعاء" حساب ضيف موجود** — يحتاج قرار مزوّد OTP أولاً (بحث أُجري: Twilio [$0.4459/رسالة
  لمصر تحديداً — مرتفع]، Vonage [سعر مصر غير مؤكَّد، يحتاج عرض مبيعات]، SMS Misr [مزوّد مصري محلي،
  0.38-1.00 جنيه/رسالة — الأرخص بفارق كبير] — عُرض على المؤسس، لم يُحسَم).
