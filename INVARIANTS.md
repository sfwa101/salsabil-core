...
|---|---|---|
| ENFORCED | 7 | INV-ORD-001, INV-ORD-003, INV-INV-001, INV-RLS-001, INV-ARCH-001, INV-SEC-002, INV-AUTHZ-001 |
...
**14 إدخالاً إجمالاً.** لا ادعاء بأن هذا شامل لكل خاصية في المشروع — هذه أول دفعة مُستخرَجة من نطاق
